...
{
	// Randomkit doesn't require deinit or close ;-)
}
...
int main(int argc, char *argv[])
{
  ...
  printf("Shamir Secret Sharing Scheme - %s\n", revision);
  printf("Copyright 2005 B. Poettering, Win32 port by Alex.Popov@leggettwood.com\n\n");
